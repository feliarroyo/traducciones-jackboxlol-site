...
export const FAQ_REGISTRY: Faq[] = [
    {
        ...
        answer: [<>Puedes reportar el error en el canal "soporte" del <a href="https://discord.gg/jackbox" target="_blank" rel="noopener noreferrer" className={link}>servidor de Discord</a>.</>, <><p>En lo posible, no escatimes en los detalles.</p> Por ejemplo: si una ocurrencia de emergencia en Quiplash 3 no está bien escrita, envía también el enunciado.</>]
    },
    {
    ...
    },
    {
        ...
        answer: [<>Esta es una traducción <b>no oficial</b> y <b>sin fines de lucro</b> de los juegos.</>, "Se aceptan donaciones con el fin de mantener el dominio de “Jackbox.lol”, utilizado para alojar la página web y el controlador."]
    },
    {
        ...
        answer: [
            ...
            <><b>Usando Steam y la Utility:</b> En la Utility {"->"} “Ajustes” {"->"} hacer clic sobre el botón de la flecha. Al hacerlo, los archivos se verificarán con Steam automáticamente.</>,
            <><b>Usando solo Steam:</b> En tu biblioteca de Steam, haz clic derecho en el juego que quieras restaurar y selecciona "Propiedades..." {"->"} "ARCHIVOS LOCALES" {"->"} "Verificar integridad de los archivos de juego...".</>,
            <><b>Con Epic Games Store:</b> Debes hacer clic en los tres puntos al lado del juego que desees restaurar y pulsar "Verificar".</>,
